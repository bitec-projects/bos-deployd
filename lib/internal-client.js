	...
	baseMethods = {
		request: function (method, options, fn) {
			var promise = new Promise(function (resolve, reject) {
				var req, res, urlKey, recursions, recursionLimit, ignoreRecursionLimit;
				...
				ignoreRecursionLimit = (stack && stack.ignoreRecursionLimit) || false;

				if (recursions < recursionLimit || ignoreRecursionLimit) {
